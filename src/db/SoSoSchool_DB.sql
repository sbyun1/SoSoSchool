...
INSERT INTO SOSO_USER VALUES
 ...
 INSERT INTO SOSO_USER VALUES
    (
        USER_NO_SQ.nextval, '관리자', '관리자', 'admin','a1234',1
        ,'987134','인천광역시 남동구 정각로 9 ','미미빌라 102-121','01092035921','admin@naver.com',
        DEFAULT, DEFAULT, DEFAULT, DEFAULT,'ADMIN','INCHEON'
    );
...
UPDATE SOSO_USER SET SUB_YN = 'N' WHERE USER_NO = 5;
------------------------------------공지사항 게사판-----------------------------------------
DROP TABLE NOTICE;
...
DROP TABLE QNA;
DROP SEQUENCE QNA_NO_SQ;
DROP SEQUENCE QNA_GNO_SQ;
...
DROP TABLE RESULT_KOR;
DROP TABLE RESULT_ENG;
DROP TABLE RESULT_MATH;

CREATE TABLE RESULT_KOR(
       USER_ID VARCHAR2(30) NOT NULL ,
       MONTH NUMBER NOT NULL,
       DAY NUMBER NOT NULL ,
       KOR NUMBER NOT NULL
);
CREATE TABLE RESULT_ENG(
   USER_ID VARCHAR2(30) NOT NULL ,
   MONTH NUMBER NOT NULL,
   DAY NUMBER NOT NULL ,
   ENG NUMBER NOT NULL
);
CREATE TABLE RESULT_MATH(
    USER_ID VARCHAR2(30) NOT NULL ,
    MONTH NUMBER NOT NULL,
    DAY NUMBER NOT NULL ,
...
-----------------------------------
-------------------------------자료실 게시판----------------------------------
DROP TABLE REF_BOARD;
DROP SEQUENCE RBOARD_NO_SQ;
