...
public class groupDao extends JDBCTemplate {
    ...
    //게시글 입력
    public int inser(groupDto dto, String gboard_region, String gboard_library){
        Connection con = getConnection();
        PreparedStatement pstm = null;
        int res = 0;
        ...
        try {
            ...
            pstm.setString(6, gboard_library);
            System.out.println("03. query 준비 " + sql);
    ...
    //게시글 수정
    public int update(groupDto dto, String gboard_region, String gboard_library){
        Connection con = getConnection();
        PreparedStatement pstm = null;
        int res = 0;

        String sql = "UPDATE SMALL_GROUP SET GBOARD_TITLE = ?, GBOARD_SUBTITLE = ?, GBOARD_CONTENT = ?, GBOARD_IMG = ? WHERE GBOARD_NO = ? AND GBOARD_REGION = ? AND GBOARD_LIBRARY = ?";
        ...
        try {
            ...
            pstm.setString(7, gboard_library);
            System.out.println("03. query 준비 " + sql);
    ...
    //게시글 삭제
    public int delete(int gboard_no, String gboard_region, String gboard_library){
        Connection con = getConnection();
        PreparedStatement pstm = null;
        int res = 0;

        String sql = "DELETE FROM SMALL_GROUP WHERE GBOARD_NO = ? AND GBOARD_REGION = ? AND GBOARD_LIBRARY = ?";
