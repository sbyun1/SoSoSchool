...
<section>
    ...
    <form action="../reference_controller.do" method="post">
        <input type="hidden" name="no" value="${referencedto.rboard_no}">
        <input type="hidden" name="command" value="ref_board_update">
        <div id="board_form">
            <div class="title_form">
                <div class="title">제목</div>
                <div class="change_title_form"><input class="change_title" type="text" name="title" value="${referencedto.rboard_title}"></div>
            </div>
            <div class="content_form">
                <div class="content">내용</div>
                <div class="change_content_form"><textarea class="change_content" name="content" placeholder="width:500; height:200으로 설정">${referencedto.rboard_content}</textarea></div>
            </div>
            <div class="img_form">
            ...
            <div class="button_form">
                ...
                <input class="button" type="button" value="삭제" onclick="location.href='../reference_controller.do?command=delete&no=${referencedto.rboard_no}'">
            </div>
        </div>
    </form>
</section>
