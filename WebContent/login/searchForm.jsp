...
<body>
 <header><h1><a href="main.jsp"><img src="/img/logo.png"></a></h1></header>
   ...
   <section>
		<div id="btnForm">
		<input type="button" class="btn" value="ID 찾기" onclick="location.href='../login_controller.do?command=searchIdForm'">
		<input type="button" class="btn" value="PW 찾기" onclick="location.href='../login_controller.do?command=searchPwForm'">
