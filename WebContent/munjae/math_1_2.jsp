...
<section>
    <div class="mainform">      <%--메인 구역 건들지 말것--%>
        ...
        <div id="munjaeform" style="width:960px; display: flex; justify-content: center; align-items: center;"> <%--//문제 구역 해당 div태그 안에서 문제 구현할것--%>
            ...
            <div style="width: 700px"> <%--//해당 div태그 아래에 문제 추가할것--%>
                <div style="border: 0">
                <div id="content"><br>
...
<br>
	...
	<h3>1.설명을 듣고 맞는 모양을 골라주세요.</h3>
	<div style="border:1px solid black; padding:5px">뾰족한 곳이 네개입니다.</div><br><br>
...
<div id="question2" style="display:none">
	<h3>2.설명을 듣고 맞는 모양을 골라주세요.</h3>
	<div style="border:1px solid black; padding:5px">뾰족한 곳이 없습니다.</div><br><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">△모양</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">○모양</button></a><br>
