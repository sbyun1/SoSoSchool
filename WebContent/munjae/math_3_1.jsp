...
function quizCheck(){
    ...
    var answer = ['28000','54000','370','396','987','498','240']; //시험 문제의 정답
    ...
    outputString += "<input type='button' value='다음 문제로 이동' onclick="+"location.href='../munjae_controller.do?command=math_second&user_no=${userdto.user_no}&correct="+correct+"'"+">";
    document.getElementById('resultarea').innerHTML = outputString;
    document.getElementById('resultarea').style.visibility = 'visible';
}
function nextPage(){
    location.href='../munjae_controller.do?command=math_second&user_no=${userdto.user_no}'+'&correct=correct';
}
