...
<br>
	...
	<h3>철자가 바른 것을 골라주세요.</h3><br>
	
	
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">selep</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">sleep</button></a><br>
	 
</div>

<div id="question2" style="display:none">
<h3>철자가 바른 것을 골라주세요.</h3>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">monkey</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">omnkey</button></a><br>
</div>
