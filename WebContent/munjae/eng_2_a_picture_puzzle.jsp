...
function quizCheck(){
    ...
    var answer = ['ORANGE','ONION','LEMON','APPLE','PEACH','KIWI','MELON']; //시험 문제의 정답
    ...
    outputString += "<hr><p>1번 정답: orange<br>2번 정답: onion<br>3번 정답: lemon<br>4번 정답: apple<br>5번 정답: peach<br>6번 정답: kiwi<br>7번 정답:melon<hr>";
