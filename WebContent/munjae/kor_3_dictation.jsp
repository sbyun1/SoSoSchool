...
<head>
    ...
    <script>
        ...
        function quizCheck(){
            ...
            var answer = ['고개를 갸우뚱하면서','그뿐만 아니라 꽃잎에 묻어','말을 세워 놓고는','밝고 경쾌한 목소리로','벗의 손에 쥐어 주었다','시냇물에 가로막혀 돌아왔지','얼마나 얄미운데요']; //시험 문제의 정답
            ...
            <form style="width: 400px"> <%--//해당 div태그 아래에 문제 추가할것--%>
                <fieldset style="border: 0">
                    ...
                    <ol>
                        <li>
                            <label for="add"></label>
                            <h2><audio src="../audio/고개를 갸우뚱하면서.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="add"></label>
                            <h2><audio src="../audio/그뿐만 아니라 꽃잎에 묻어.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="sub"></label>
                            <h2><audio src="../audio/말을 세워 놓고는.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="multi"> </label>
                            <h2><audio src="../audio/밝고 경쾌한 목소리로.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="div"></label>
                            <h2><audio src="../audio/벗의 손에 쥐어 주었다.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/시냇물에 가로막혀 돌아왔지.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/얼마나 얄미운데요.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
