...
<head>
    ...
    <script>
        ...
        function quizCheck(){
            ...
            var answer = ['바른 말로 대화하기','보름달을 가리키셨어','생김새가 조금 다르다','저녁으로 주먹밥을 먹었다','접시를 꺼내','책을 잃어버렸다','한 문제를 틀렸습니다' ]; //시험 문제의 정답
            ...
            <form style="width: 400px"> <%--//해당 div태그 아래에 문제 추가할것--%>
                <fieldset style="border: 0">
                    ...
                    <ol>
                        <li>
                            <label for="add"></label>
                            <h2><audio src="../audio/바른 말로 대화하기.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="add"></label>
                            <h2><audio src="../audio/보름달을 가리키셨어.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="sub"></label>
                            <h2><audio src="../audio/생김새가 조금 다르다.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="multi"> </label>
                            <h2><audio src="../audio/저녁으로 주먹밥을 먹었다.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="div"></label>
                            <h2><audio src="../audio/접시를 꺼내.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/책을 잃어버렸다.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/한 문제를 틀렸습니다.mp3" controls></audio></h2>
                            <input placeholder="들리는 소리를 적으세요."  type="text"/>
                        </li>
