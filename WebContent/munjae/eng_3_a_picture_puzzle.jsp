...
function quizCheck(){
    ...
    var answer = ['LION','ELEPHANT','GIRAFFE','ZEBRA','WOLF','MONKEY','BEAR']; //시험 문제의 정답
    ...
    for(var i=0;i < 8; i++){
        questionElement.push(document.forms[0].elements[i+2].value.toUpperCase());
    ...
    outputString += "<hr><p>1번 정답: lion<br>2번 정답: elephant<br>3번 정답: giraffe<br>4번 정답: zebra<br>5번 정답: wolf<br>6번 정답: monkey<br>7번 정답:baer<hr>";
    outputString += "<p>최종 점수는 <strong>"+sum+"점</strong> 입니다.</p>";
    outputString += "<input type='button' value='성적 제출하기' onclick="+"location.href='../munjae_controller.do?command=eng_final&user_no=${userdto.user_no}&correct="+correct+"&sum="+sum+"&month="+month+"&date="+date+"'"+">";
    ...
    <div class="mainform">      <%--메인 구역 건들지 말것--%>
        <div id="buttonfrom" style="width: 960px; min-height: 100px; display: flex; flex-wrap: wrap">    <%--각 문제 페이지로 이동할 수 있는 버튼 구역 건들지 말것--%>
            ...
            <div id="button_2" style="width: 320px; display: flex; align-items: center; justify-content: center">
                <button class="buttonss">단어</button>
            </div>
            ...
            <form style="width: 400px"> <%--//해당 div태그 아래에 문제 추가할것--%>
                <fieldset style="border: 0">
                    ...
                    <ol>
    					...
    					<input style="width:120px;" type="text" id="answer" value="">
