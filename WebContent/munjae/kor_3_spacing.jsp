...
<head>
    ...
    <script>
        ...
        function quizCheck(){
            ...
            var answer = ['빨간 감이 탐스럽게 열려','붕붕 날아오를 것 같았어','뭘 먹고 그토록 아름다운','소달구지에서 떨어진 흙덩이','모두 정신없는 사이에도','하늘이 맑고 푸르다']; //시험 문제의 정답
            ...
            outputString += "<hr><p>띄어쓰기 정답<br><br>1번 정답: 빨간 감이 탐스럽게 열려<br>2번 정답: 붕붕 날아오를 것 같았어<br>3번 정답: 뭘 먹고 그토록 아름다운<br>4번 정답: 소달구지에서 떨어진 흙덩이<br>5번 정답: 모두 정신없는 사이에도<br>6번 정답: 하늘이 맑고 푸르다</p><hr>";
            outputString += "<p>받아쓰기 정답<br><br>1번 정답: 고개를 갸우뚱하면서<br>2번 정답: 그뿐만 아니라 꽃잎에 묻어<br>3번 정답: 말을 세워 놓고는<br>4번 정답: 밝고 경쾌한 목소리로<br>5번 정답: 벗의 손에 쥐어 주었다<br>6번 정답: 시냇물에 가로막혀 돌아왔지<br>7번 정답: 얼마나 얄미운데요 ";
