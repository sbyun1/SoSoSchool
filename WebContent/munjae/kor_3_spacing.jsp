...
function quizCheck(){
    ...
    var answer = ['빨간 감이 탐스럽게 열려','붕붕 날아오를 것 같았어','뭘 먹고 그토록 아름다운','소달구지에서 떨어진 흙덩이']; //시험 문제의 정답
    ...
    outputString += "<hr><p>1번 정답: 빨간 감이 탐스럽게 열려<br>2번 정답: 붕붕 날아오를 것 같았어<br>3번 정답: 뭘 먹고 그토록 아름다운<br>4번 정답: 소달구지에서 떨어진 흙덩이<br></p><hr>"; 
