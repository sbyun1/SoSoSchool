...
<head>
    ...
    <script type="text/javascript">
        var delay=60; //시간설정
        var correctAnswers=new Array("a","b","a","a","a","b","b");  //정답
        var q_num=1;
        var timer;
        var layer;
        var clock=delay;
    ...
    <div class="mainform">      <%--메인 구역 건들지 말것--%>
        <div id="buttonfrom" style="width: 960px; min-height: 100px; display: flex; flex-wrap: wrap">    <%--각 문제 페이지로 이동할 수 있는 버튼 구역 건들지 말것--%>
            <div id="button_1" style="width: 320px; display: flex; align-items: center; justify-content: center">    <%--버튼을 감싸는 div태그--%>
                <a href="kor_2_dictation.jsp"><button class="buttonss">받아쓰기</button></a>  <%--//onclick 추가해서 페이지 넘기는 기능 구현 할 것--%>
            </div>
            <div id="button_2" style="width: 320px; display: flex; align-items: center; justify-content: center">
                <a href="kor_2_spelling.jsp"> <button class="buttonss">맞춤법</button></a>
            </div>
                ...
                <div style="border: 0">
                    <div id="content"><br>
                        ...
                        <div id="question1" style="display:none">
                            ...
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">헤어진 가족을 만나고 싶어.</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">해어진 가족을 만나고 싶어.</button></a><br>

                        </div>

                        <div id="question2" style="display:none">
                            <h3>2.다음 중 옳은 표기법은 무엇일까요?</h3><br>
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">아레 발치에서</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">아래 발치에서</button></a><br>
                        </div>

                        <div id="question3" style="display:none">
                            <h3>3.다음 중 옳은 표기법은 무엇일까요?</h3><br>
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">빙그레 웃으시더니</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">빙그래 웃으시더니</button></a><br>
                        </div>

                        <div id="question4" style="display:none">
                            <h3>4.다음 중 옳은 표기법은 무엇일까요?</h3><br>
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">어이 없다</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">어의 없다</button></a><br>
                        </div>

                        <div id="question5" style="display:none">
                            <h3>5.다음 중 옳은 표기법은 무엇일까요?</h3><br>
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">A가 B보다 더 낫다</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">A가 B보다 더 낳다</button></a><br>
                        </div>

                        <div id="question6" style="display:none">
                            <h3>6.다음 중 옳은 표기법은 무엇일까요?</h3><br>
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">문안하다</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">무난하다</button></a><br>
                        </div>

                        <div id="question7" style="display:none">
                            <h3>7.다음 중 옳은 표기법은 무엇일까요?</h3><br>
                            <a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">들어나다</button></a><h2>VS</h2>
                            <a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">드러나다</button></a><br>
                        </div>
