...
<br>
	...
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">씻었습니다</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">씻었읍니다</button></a><br>
	 
</div>

<div id="question2" style="display:none">
<h3>2.다음 중 옳은 표기법은 무엇일까요?</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">깨끗히</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">깨끗이</button></a><br>
</div>

<div id="question3" style="display:none">
<h3>3.다음 중 옳은 표기법은 무엇일까요?</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">쫑긋쫑긋</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">쫑끗쫑끗</button></a><br>
</div>

<div id="question4" style="display:none">
<h3>4.다음 중 옳은 표기법은 무엇일까요?</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">배짱이</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">베짱이</button></a><br>
</div>

<div id="question5" style="display:none">
<h3>5.다음 중 옳은 표기법은 무엇일까요?</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">사뿐이</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">사뿐히</button></a><br>
</div>

<div id="question6" style="display:none">
<h3>6.다음 중 옳은 표기법은 무엇일까요?</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">학굣길</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">학교길</button></a><br>
</div>

<div id="question7" style="display:none">
<h3>7.다음 중 옳은 표기법은 무엇일까요?</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">붙혀진</button></a><h2>VS</h2>
