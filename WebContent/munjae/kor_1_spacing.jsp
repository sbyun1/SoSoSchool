...
<head>
    ...
    <script>
        ...
        function quizCheck(){
            ...
            var answer = ['큰 소리로 응원합니다','동물의 모양에 빗댄 것','들은 체 만 체 하며','가방을 메고 큰 소리로','여기는 나밖에 없어','책장을 착착 넘기더니']; //시험 문제의 정답
            ...
            outputString += "<hr><p>띄어쓰기 정답<br><br>1번 정답: 큰 소리로 응원합니다<br>2번 정답: 동물의 모양에 빗댄 것<br>3번 정답: 들은 체 만 체 하며<br>4번 정답: 가방을 메고 큰 소리로<br>5번 정답: 여기는 나밖에 없어<br>6번 정답: 책장을 착착 넘기더니</p>";
            outputString += "<hr><p>받아쓰기 정답<br><br>1번 정답: 뒤를<br>2번 정답: 따라갑니다<br>3번 정답: 꾀 많은 여우가<br>4번 정답: 꿀을 따서<br>5번 정답: 나눠 먹지 않을래";
            outputString += "<br>6번 정답: 나무에 있는<br>7번 정답: 다가갑니다<hr>";
