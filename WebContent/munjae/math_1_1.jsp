...
<br>
	...
	<h3>1.다음 중 큰 수를 골라주세요.</h3>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">100</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">32</button></a><br>
	 
</div>

<div id="question2" style="display:none">
<h3>2.다음 중 큰 수를 골라주세요.</h3><br>
	<a href="javascript:void(0)" onclick="check_answer('a')"><button class="buttonss">29</button></a><h2>VS</h2>
	<a href="javascript:void(0)" onclick="check_answer('b')"><button class="buttonss">12</button></a><br>
</div>

<div id="question3" style="display:none">
<h3>3.다음 중 큰 수를 골라주세요.</h3><br>
