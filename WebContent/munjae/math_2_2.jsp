...
function quizCheck(){
    ...
    var answer = ['200','43','280','500','1','120','70']; //시험 문제의 정답
                ...
                <fieldset style="border: 0">
                    ...
                    <ol>
                       <li>
                        ...
                        <li>
                            <label for="add"></label>
                            <h4>35m에 800cm를 더하면 ___m입니다.</h4>
                            <input placeholder=""  type="text"/>
                        </li>
                        <li>
                            <label for="sub"></label>
                            <h4>2m 80cm는 ___cm입니다.</h4>
                            <input placeholder=""  type="text"/>
                        </li>
                        <li>
                            <label for="sub"></label>
                        ...
                        <li>
                            <label for="sub"></label>
                            <h4>25cm에 75cm를 더하면 ____m입니다.</h4>
                            <input placeholder=""  type="text"/>
                        </li>
                        <li>
                            <label for="sub"></label>
                            <h4>1m 20cm는 ___cm입니다.</h4>
                            <input placeholder=""  type="text"/>
                        </li>
                        <li>
                            <label for="sub"></label>
                            <h4>2m 40cm에서 1m 70cm를 빼면 ___cm입니다.</h4>
                            <input placeholder=""  type="text"/>
                        </li>
