...
<head>
    ...
    <script>
        ...
        function init () {
            document.forms[0].elements[12].addEventListener("click", quizCheck, false);
        }
        function quizCheck(){
            var examineeName = document.forms[0].name.value; // 응시자 이름
            var answer = ['뒤를','따라갑니다','꾀 많은 여우가','꿀을 따서','나눠 먹지 않을래','나무에 있는','다가갑니다','성큼성큼','슬금슬금','잡고 있습니다']; //시험 문제의 정답
            ...
            outputString += "<hr><p>1번 정답: 뒤를<br>2번 정답: 따라갑니다<br>3번 정답: 꾀 많은 여우가<br>4번 정답: 꿀을 따서<br>5번 정답: 나눠 먹지 않을래 ";
            outputString += "6번 정답: 나무에 있는<br>7번 정답: 다가갑니다<br>8번 정답: 성큼성큼<br>9번 정답: 슬금슬금<br>10번 정답: 잡고 있습니다</p><hr>";
                ...
                <fieldset style="border: 0">
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <h2><audio src="../audio/꿀을 따서.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                        <li>
                            <label for="div"></label>
                            <h2><audio src="../audio/나눠 먹지 않을래.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/나무에 있는.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/다가갑니다.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/성큼성큼.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/슬금슬금.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                        <li>
                            <label for="asmd"> </label>
                            <h2><audio src="../audio/잡고 있습니다.mp3" controls></audio></h2>
                            <input type="text"/>
                        </li>
                    </ol>
                    <div>
